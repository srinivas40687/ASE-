angular.module('MyModule',[])
    .controller('MyController', function ($scope,$http) {
        $scope.retrieveData = function (){
            ...
            $scope.query=query;
            var resp=$http.get("https://api.foursquare.com/v2/venues/search?ll=39.0997,-94.5783&query="+query+"&limit=6&client_id=P2IIU4YKUJ2ILBZMYLTDO42TUKACIOTJ5QVEYUK3F2ZAW0K3&client_secret=3A3ZTVHPSK4VU2T2YJLY0SSD43IH1Z32JAQNAEV4DWMLOSPZ&v=20130815");
        ...
        $scope.calcWeather = function (){
            ...
            var resp=$http.get("http://api.openweathermap.org/data/2.5/weather?q=kansas city&units=imperial&appid=ba46ee733b337f4d3e99cdd312b0c51e");
            resp.success(function(data,status, headers,config){
